...
a1 <- poisson_maxsprt(data, h1=110)
...
test_that("df parameter functions as expected", {
  ...
  expect_true(all(names(a2) %in% c("test_name",
                                   ...
                                   "params",
                                   "data")))
  expect_equal(a2$test_name, "Poisson MaxSPRT")
...
a2 <- poisson_maxsprt(a2d, ts_event=c("Rate"="rate"), h1=8)
...
a2 <- poisson_maxsprt(a2d, analysis_of="Testing", h1=8)
test_that("ts_event parameter functions as expected", {
  expect_equal(a2$analysis_of, "Testing")
})

test_that("eval_period parameter functions as expected", {
  expect_error(poisson_maxsprt(a2d, eval_period=0, h1=8))
  expect_error(poisson_maxsprt(a2d, eval_period=5.5, h1=8))
  expect_error(poisson_maxsprt(a2d, eval_period=26, h1=8))
  expect_error(poisson_maxsprt(a2d, eval_period=10, obs_period=11, h1=8))
})

test_that("obs_period parameter functions as expected", {
  expect_is(poisson_maxsprt(a2d, obs_period=3, h1=8), "mdsstat_test")
  expect_is(poisson_maxsprt(a2d, obs_period=12, h0=1, h1=8), "mdsstat_test")
  expect_error(poisson_maxsprt(a2d, obs_period=0, h1=8))
  expect_error(poisson_maxsprt(a2d, obs_period=5.5, h1=8))
  expect_error(poisson_maxsprt(a2d, obs_period=26, h1=8))
  expect_error(poisson_maxsprt(a2d, obs_period=25, h1=8))
  expect_error(poisson_maxsprt(a2d, obs_period="now", h1=8))
})

test_that("h0 parameter functions as expected", {
  expect_is(poisson_maxsprt(a2d, h0=0.1, h1=8), "mdsstat_test")
  expect_is(poisson_maxsprt(a2d, h0=25, h1=8), "mdsstat_test")
  expect_error(poisson_maxsprt(a2d, h0=0, h1=8))
  expect_error(poisson_maxsprt(a2d, h0=-1, h1=8))
  expect_error(poisson_maxsprt(a2d, h0="null", h1=8))
})

a2e <- poisson_maxsprt(a2d, h1=8, relative_risk=1.2)
a2f <- poisson_maxsprt(a2d, h1=8)
test_that("h1 parameter functions as expected", {
  ...
  expect_is(poisson_maxsprt(a2d, h0=25, h1=8), "mdsstat_test")
  expect_error(poisson_maxsprt(a2d, h1=0))
  expect_error(poisson_maxsprt(a2d, h1=-1))
  expect_error(poisson_maxsprt(a2d, h1="null"))
})

a2g <- poisson_maxsprt(a2d, relative_risk=1.2)
test_that("relative_risk parameter functions as expected", {
  ...
  expect_is(poisson_maxsprt(a2d, relative_risk=2), "mdsstat_test")
  expect_error(poisson_maxsprt(a2d, relative_risk=0))
  expect_error(poisson_maxsprt(a2d, relative_risk=-1))
  expect_error(poisson_maxsprt(a2d, relative_risk=1))
  expect_error(poisson_maxsprt(a2d, relative_risk="null"))
})

a2h <- poisson_maxsprt(a2d, h1=8, distribution="normal")
test_that("relative_risk parameter functions as expected", {
  expect_is(a2h, "mdsstat_test")
  expect_equal(a2h$test_name, "Normal SPRT")
  expect_error(poisson_maxsprt(a2d, h1=8, distribution=3))
  expect_error(poisson_maxsprt(a2d, h1=8, distribution="exponential"))
  expect_error(poisson_maxsprt(a2d, h1=8, distribution="binomial"))
})

a2i <- poisson_maxsprt(a2d, h1=8, alpha=0.01)
test_that("alpha parameter functions as expected", {
  expect_error(poisson_maxsprt(a2d, h1=8, alpha=0))
  expect_error(poisson_maxsprt(a2d, h1=8, alpha=1))
  expect_error(poisson_maxsprt(a2d, h1=8, alpha=-.01))
  expect_error(poisson_maxsprt(a2d, h1=8, alpha=1.01))
  expect_is(a2i, "mdsstat_test")
  expect_equal(a2i$params$alpha, 0.01)
})

a2i <- poisson_maxsprt(a2d, h1=8, beta=0.01)
test_that("alpha parameter functions as expected", {
  expect_error(poisson_maxsprt(a2d, h1=8, beta=0))
  expect_error(poisson_maxsprt(a2d, h1=8, beta=1))
  expect_error(poisson_maxsprt(a2d, h1=8, beta=-.01))
  expect_error(poisson_maxsprt(a2d, h1=8, beta=1.01))
  expect_is(a2i, "mdsstat_test")
  expect_equal(a2i$params$beta, 0.01)
})

a3 <- poisson_maxsprt(a2d, h1=8)
a3a <- poisson_maxsprt(a2d, h1=8, h1_type="greater")
a3b <- poisson_maxsprt(a2d, h1=8, h1_type="less")
a3c <- poisson_maxsprt(a2d, h1=8, h1_type="not equal")
test_that("h1_type parameter functions as expected", {
  ...
  expect_error(poisson_maxsprt(a2d, h1=8, h1_type=2))
  expect_error(poisson_maxsprt(a2d, h1=8, h1_type="not"))
})
